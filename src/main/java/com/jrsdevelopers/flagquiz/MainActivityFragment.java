...
public class MainActivityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        guessLinearLayouts[0] =
                (LinearLayout) view.findViewById(R.id.row1LilinearLayout);
    ...
    protected View.OnClickListener guessButtonListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (guess.equals(answer)) { // if the guess is correct
                ...
                answerTextView.setTextColor(
                        getResources().getColor(R.color.correct_answer_,
                                getContext().getTheme()));
                ...
                if (correctAnswers == FLAGS_IN_QUIZ) {
                    ...
                    quizLinearLayout.postDelayed( new Runnable() {
                        @Override
                        public void run() {
